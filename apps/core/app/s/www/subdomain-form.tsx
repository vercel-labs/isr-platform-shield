...
import { createSubdomainAction } from "@/app/s/www/actions";
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex flex-col gap-2">
          ...
          <Card className="flex-1 flex flex-row items-center justify-between p-2 border border-input rounded-md">
            <div className="min-w-[40px] min-h-[40px] flex items-center pl-[14px] select-none">
              {icon ? (
                ...
                <span className="text-sm font-normal">No icon selected</span>
              )}
            </div>
        ...
        <p className="text-xs">Select an emoji to represent your subdomain</p>
      </div>
    </div>
  );
}
